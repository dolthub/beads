...
var rootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := metrics.Init(Version, resolveMetricsEnabled(), resolvePostHogAPIKey()); err != nil {
...
func resolvePostHogAPIKey() string {
	if v := os.Getenv(metrics.EnvPostHogAPIKey); v != "" {
		return v
	}
	return config.GetString("metrics.posthog.api_key")
}
